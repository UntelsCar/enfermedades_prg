                            ...
                            <ul class="mb-6 flex flex-col gap-1.5">
                                    ...
                                    <li>
                                        <form action="/enfermedades_prg/controlador/medico/agregarPacienteController.php" method="post">
                                            <button name="b_agregarPaciente" type="submit" class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white hover:text-yellow-300 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4">
